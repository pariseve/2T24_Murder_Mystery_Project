...
public class NPCTriggerEnterBoolDialogue : MonoBehaviour
{
    ...
    private void OnTriggerStay(Collider other)
    {
        if (other.CompareTag("Player"))
        {
            ...
            if (!PlayerPrefs.HasKey(conversationTriggeredKey) && isInsideTrigger && AllRequiredBoolsTrue() && AllRequiredBoolsFalse())
            {
                StartConversation();
            }
        }
