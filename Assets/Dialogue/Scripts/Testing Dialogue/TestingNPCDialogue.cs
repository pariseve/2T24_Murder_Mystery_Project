...
public class TestingNPCDialogue : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        // Check if the conversation has already started and the player is still inside the trigger area
        if (conversationStarted && isInsideTrigger && Input.GetMouseButtonDown(0))
        {
